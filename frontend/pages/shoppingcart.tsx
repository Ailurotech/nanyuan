      ...
      <div className="md:w-3/4 mx-2 md:mx-auto md:p-12 p-5 bg-zinc-800 rounded-lg shadow-2xl">
        ...
        <div className="md:py-6 border-t-2 border-white md:mt-6 mt-5">
          ...
          <div className="flex justify-between flex-col gap-5 mx-auto md:flex-row">
            <Link
              href={NavigationRoute.Menu.Path}
              className="w-100 flex justify-center"
            >
              <Button className="bg-white p-3 font-bold px-32 w-1/3 md:ml-10 md:w-3/4">
                ADD MORE
              </Button>
            </Link>
            <Link href={NavigationRoute.Takeaway.Path} className="w-100 flex justify-center">
